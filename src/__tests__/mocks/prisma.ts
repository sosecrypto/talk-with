...
export function resetPrismaMocks() {
  ...
  vi.mocked(prisma.conversationFeedback.findFirst).mockReset()
  vi.mocked(prisma.conversationFeedback.findMany).mockReset()
  vi.mocked(prisma.conversationFeedback.create).mockReset()
  ...
  vi.mocked(prisma.source.findUnique).mockReset()
  vi.mocked(prisma.source.findFirst).mockReset()
  vi.mocked(prisma.source.create).mockReset()
  vi.mocked(prisma.source.update).mockReset()
  vi.mocked(prisma.source.delete).mockReset()
  vi.mocked(prisma.source.count).mockReset()
  vi.mocked(prisma.source.groupBy).mockReset()
  vi.mocked(prisma.fetchLog.findMany).mockReset()
  vi.mocked(prisma.fetchLog.create).mockReset()
  vi.mocked(prisma.fetchLog.count).mockReset()
